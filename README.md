...
```bash
# Install the chart
helm install my-release oci://ghcr.io/okassov/charts/universal --version 1.5.0

# Install with custom values
helm install my-release oci://ghcr.io/okassov/charts/universal --version 1.5.0 -f values.yaml

# Upgrade
helm upgrade my-release oci://ghcr.io/okassov/charts/universal --version 1.5.0
```
...
```bash
# Download the chart
helm pull oci://ghcr.io/okassov/charts/universal --version 1.5.0

# Extract and install
tar -xzf universal-1.5.0.tgz
